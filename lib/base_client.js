...
ThothSC.BaseClient = SC.Object.extend({
  ...
  ThothURLPrefix: function(){
    if(this.dataSource && this.dataSource.ThothURLPrefix) return this.dataSource.get('ThothURLPrefix');
    else return '/thoth';
  }.property().cacheable(),
  ...
  */
  ...
  on: function(event,handler,context){
    ...
    var func = function(){
      ...
      SC.RunLoop.begin();
      if(shouldLog){
        SC.Logger.log("ThothSC: Incoming event: " + event + ", data: " + arguments[0]);
